...
public class WebIATWS extends WebSocketListener {
	...
	private static final String appid = "1cd768c1"; //在控制台-我的应用获取
    public static final String apiSecret = "OGI4MWU2YzE3YTVlNDg0NDlkZWQwMTNi"; //在控制台-我的应用-语音听写（流式版）获取
    public static final String apiKey = "aea3b6cfe22378d28231d123628d872e"; //在控制台-我的应用-语音听写（流式版）获取
    ...
    public void onOpen(WebSocket webSocket, Response response) {
        ...
        new Thread(()->{
            ...
            int intervel = 40;
            int status = 0;  // 音频的状态
            try (InputStream fs = new ByteArrayInputStream(mData)) {
    ...
    public void onMessage(WebSocket webSocket, String text) {
        ...
        if (resp != null) {
            if (resp.getCode() != 0) {
                result = "code=>" + resp.getCode() + " error=>" + resp.getMessage() + " sid=" + resp.getSid();
            ...
            if (resp.getData() != null) {
                ...
                if (resp.getData().getStatus() == 2) {
                    ...
                    dateEnd = new Date();
                    System.out.println("cost = " + (dateEnd.getTime() - dateBegin.getTime()) + "ms");
